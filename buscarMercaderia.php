...
if($_GET['tipo'] == 'id_mercaderia')
{
$select = "SELECT mercaderia.id_mercaderia, mercaderia.cantidad_bultos, mercaderia.peso, mercaderia.descripcion, movimiento_comercial.id_movimiento_comercial FROM mercaderia, movimiento_comercial WHERE mercaderia.movimiento_comercial = movimiento_comercial.id_movimiento_comercial AND mercaderia.id_mercaderia LIKE '" . $_GET['parametro'] . "%';";
}else{
$select = "SELECT mercaderia.id_mercaderia, mercaderia.cantidad_bultos, mercaderia.peso, mercaderia.descripcion, movimiento_comercial.id_movimiento_comercial FROM mercaderia, movimiento_comercial WHERE mercaderia.movimiento_comercial = movimiento_comercial.id_movimiento_comercial AND movimiento_comercial.id_movimiento_comercial LIKE '" . $_GET['parametro'] . "%';";
}
